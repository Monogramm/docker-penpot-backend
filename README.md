...
-   1.5.2-alpha-jdk-11-slim-buster 1.5-jdk-11-slim-buster jdk-11-slim-buster 1.5.2-alpha 1.5 latest  (`images/1.5/openjdk-11-tools-deps-slim-buster/Dockerfile`)
-   1.5.2-alpha-jdk-16-alpine 1.5-jdk-16-alpine jdk-16-alpine  (`images/1.5/openjdk-16-tools-deps-alpine/Dockerfile`)
