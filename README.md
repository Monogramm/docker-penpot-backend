...
-   1.4.1-alpha-jdk-11-slim-buster 1.4-jdk-11-slim-buster jdk-11-slim-buster 1.4.1-alpha 1.4 latest  (`images/1.4/openjdk-11-tools-deps-slim-buster/Dockerfile`)
-   1.4.1-alpha-jdk-16-alpine 1.4-jdk-16-alpine jdk-16-alpine  (`images/1.4/openjdk-16-tools-deps-alpine/Dockerfile`)
